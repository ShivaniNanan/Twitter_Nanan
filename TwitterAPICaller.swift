...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "vnZGuvGzVZSV1uCzlhoZVXcpk", consumerSecret: "Pdlps07gAozYqhZtg9MVv6iPODPhS3PVVAwMscJQ3qRxQxgKeN")
    var loginSuccess: (() -> ())?
